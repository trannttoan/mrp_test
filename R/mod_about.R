  ...
  tagList(
    fluidRow(
      column(width = 6, offset = 3,
        ...
        tags$h4("References\n"),
        tags$ul(
          tags$li(tags$a("Y Si (2023). On the Use of Auxiliary Variables in Multilevel Regression and Poststratification, under review by Statistical Science.", href = "https://arxiv.org/abs/2011.00360", target = "_blank")),
